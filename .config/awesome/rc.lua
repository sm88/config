...
terminal = "terminator -b --profile=solar"
...
screenuwidget = widget({ type = "textbox" })
screendwidget = widget({ type = "textbox" })

voluwidget = widget({ type = "textbox" })
volmwidget = widget({ type = "textbox" })
voldwidget = widget({ type = "textbox" })
-- }}}sush widgets end
...
-- {{{sush register viciously
vicious.register(memwidget, vicious.widgets.mem, "<span color='yellow'>M:$1% | </span>", 3)
vicious.register(cpuwidget, vicious.widgets.cpu, "<span color='yellow'>C:$1% | </span>", 3)
vicious.register(batwidget, vicious.widgets.bat, "<span color='yellow'>B:$1$2% ($3) | </span>", 60, "BAT1")
-- }}}sush end register
-- Create a systray
